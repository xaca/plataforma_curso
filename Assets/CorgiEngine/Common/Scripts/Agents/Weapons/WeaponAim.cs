...
{	
	...
	public class WeaponAim : MonoBehaviour 
	{
		...
		public enum AimControls { Off, PrimaryMovement, SecondaryMovement, Mouse }
		...
		protected virtual void DetermineWeaponRotation()
		{
			...
			{
				CurrentAngle = 0f;
				RotateWeapon(Quaternion.identity);
			}
		...
		protected virtual void InitializeReticle()
		{
			...
			if (_weapon.Owner != null)
			{
				...
				{
					_reticle.transform.SetParent(_weapon.Owner.transform);
				}
				else
				{
